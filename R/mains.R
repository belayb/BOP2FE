...
#' can be obtained by calling `Optimal_pars_binary()` function. 
#' 
#' @param H0 the probability of response under the null hypothesis 
#' @param n vector of sample size at each interim look (Note that the sample size at interim is the difference between sample size at interim i and at interim i-1)
...
#' design parameter values that are identified to optimize power while controlling
#' type I error rate at a specified value. The optimal parameters (i.e., lambda, gamma, and eta)
#' can be obtained by calling `Optimal_pars_nested()` function. 
#' 
...
#' design parameter values that are identified to optimize power while controlling
#' type I error rate at a specified value. The optimal parameters (i.e., lambda, gamma, and eta)
#' can be obtained by calling `Optimal_pars_coprimary()` function. 
#' 
...
#' design parameter values that are identified to optimize power while controlling
#' type I error rate at a specified value. The optimal parameters (i.e., lambda, gamma, and eta)
#' can be obtained by calling `Optimal_pars_jointefftox()` function. 
#' 
